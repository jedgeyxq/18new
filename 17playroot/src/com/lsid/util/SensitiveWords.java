...
public class SensitiveWords {
    ...
    static {
    		if (Files.exists(Paths.get("sensitivewords"))) {
        		try {
					SensitiveWords.init(Files.readAllLines(Paths.get("sensitivewords"), Charset.forName("UTF-8")));
					System.out.println(new Date()+" ==== Sensitive words loaded");
				} catch (Exception e) {
					System.out.println(new Date()+" ==== Sensitive words not loaded due to below exception:");
					e.printStackTrace();
				}
        }
    }
