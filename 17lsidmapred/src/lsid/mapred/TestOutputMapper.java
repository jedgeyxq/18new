...
public class TestOutputMapper extends TableMapper<ImmutableBytesWritable, ImmutableBytesWritable> {
...
//					String ip=parts[7];
//					
//					String  txt=openid+","+ip+","+lucktime+","+code;					
//					ImmutableBytesWritable val = new ImmutableBytesWritable();
//					val.set(Bytes.toBytes(txt));
//					ImmutableBytesWritable t = new ImmutableBytesWritable();
//					String eid="t1";
//					t.set(Bytes.toBytes(eid));
//					context.write(t, val);
//	   			}
//			}else if("a".equals(parts[2])){	
//				
////				throw new Exception(Bytes.toString(c));
////				
//				long lucktime = 0l;
//	   			if (parts.length>33) {
//	   				try {
...
//   				
//	   			String scantime=sdf.format(date1);	
//	   			if(scantime.equals("2016-10")||scantime.equals("2016-11")){
//
//					String uuid =parts[17];	
//					String openid=DefaultCipher.dec(uuid);
//					String code=parts[3];
...
//	   			}
//			}			
					if("vAp5vugXSAABp7KTl1MKPg%3D%3D".equals(parts[3])){
						String txt=parts[36]+","+parts[38];
						ImmutableBytesWritable val = new ImmutableBytesWritable();
						val.set(Bytes.toBytes(txt));
