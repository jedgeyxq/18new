...
public class TzbScanOutputMapper extends TableMapper<ImmutableBytesWritable, ImmutableBytesWritable> {
	...
	public void map(ImmutableBytesWritable row, Result value, Context context)
		...
		try {
			...
			if (c != null && Bytes.toString(c) != null) {				
				...
				if ("m".equals(parts[2])) {
					long lucktime = Long.parseLong(parts[16]);
//		   			if (parts.length>33) {
//		   				try {
...
//				String prizename=parts[34]+parts[35];
				...
				//String  txt=openid+","+nickname1+","+gen+","+province+","+city+","+scantime;
	   		//	String  txt=openid+","+province;
	   			String  txt=openid+","+useragent;
