...
public class TzbTop10UserMapper extends TableMapper<ImmutableBytesWritable, ImmutableBytesWritable> {
	...
	/*
	 ...
	 1501475236765# 抽完奖时间
	 K6qiBo6RgxWyZ0AIYNQCbw%3D%3D# 用户领奖输入信息
	 1501476768039 领奖时间
	 */

	static String[] arr= new String[]{"ojawIwhX2Lttf5YyEpjqFTKpZN6E","ojawIwnPrv2PSRPdoM-RBe77TqCo",
		"ojawIwol3KOB8y8hic-0ryuZJ870",
		"ojawIwj-_ETruSnf8jPESvRbaF9I",
		"ojawIwt4PKualGj7uBMvUnTjL2qw",
		"ojawIwv6zbGrxeo71-gZY5KLUIPI",
		"ojawIwmi9Yp0Wag5R9R0oL_FtfC4",
		"ojawIwqIAF5-lk_69XSgno9cNij4",
		"ojawIwvTVq8X8arRyoiTyMjjbn88",
		"ojawIwlBEMVRWzofDzUuvp7SR68g",
		"ojawIwocROjy-Azzqv6xmSpbU7lU",
		"ojawIwon7kVUNmo59eW4PDlZCUno"};
...
//				String prize = parts[35];				
				...
				String  txt=openid+","+nickname1+","+gen+","+headimgurl+","+ip+","+address+","+scantime+","+prizename;
